...
public class Client {
    ...
    public static class Builder{
        ...
        public Builder(String email, String phone_number){
            this.client_id = 0;
    ...
    public static Client createClient(long client_id, String first_name, String last_name, String phone_number, String email, String pwd){
        return new Client.Builder(email, phone_number).withPwd(pwd).withAll(client_id, first_name, last_name, phone_number).build();
    }
    public static Client createClientWithoutId(String email, String phone_number, String pwd){
        return new Client.Builder(email, phone_number).withPwd(pwd).build();
    }

    public static Client createClientUpdate(String first_name, String last_name, String phone_number, String email){
        return new Client.Builder(email, phone_number).forUpdate(first_name, last_name, phone_number).build();
    }
